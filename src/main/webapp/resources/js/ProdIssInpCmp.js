...
/*$(document).keypress(function(event) {
	...
	if (keycode == '13') {
		document.getElementById('ProdIssInpCmp:prodIsscmpBtn').click();
		return false;
	}
});*/
...
customOnload = function(){	
	...
	document.getElementById('ProdIssInpCmp:prodIsscmpBtn').focus();
